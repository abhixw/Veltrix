...
const Cart = ({ token }) => {
    ...
    return (
        <div style={{ marginTop: '2rem', padding: '0 2rem' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2.5rem', paddingBottom: '1.5rem', borderBottom: '1px solid #e2e8f0', flexWrap: 'wrap', gap: '1rem' }}>
                <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', maxWidth: '900px', margin: '0 auto' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0', background: '#fff', border: '1px solid #e2e8f0', borderRadius: '12px', overflow: 'hidden' }}>
                        {cartItems.map((item, index) => (
                            <div key={item.id} style={{ display: 'flex', alignItems: 'center', padding: '1.5rem', borderBottom: index < cartItems.length - 1 ? '1px solid #e2e8f0' : 'none', flexWrap: 'wrap', gap: '1rem' }}>

                                {/* Product Image */}
                                <div style={{ width: '80px', height: '80px', borderRadius: '8px', background: '#f8fafc', overflow: 'hidden', border: '1px solid #e2e8f0', flexShrink: 0 }}>
                                ...
                                {/* Individual Price */}
                                <div style={{ width: '100px', fontWeight: '800', fontSize: '1rem', color: '#0f172a' }}>
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', justifyContent: 'center', width: '120px', marginLeft: 'auto' }}>
                                ...
                                <button onClick={() => handleRemoveItem(item.id)} style={{ background: 'none', border: 'none', cursor: 'pointer', padding: '0.5rem' }}>
                    ...
                    <div style={{ padding: '2rem 1.5rem', borderTop: '2px solid #e2e8f0', display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '1rem', flexWrap: 'wrap', gap: '1.5rem' }}>
                        <div>
                        ...
                        <button className="btn btn-primary" style={{ padding: '1rem 2rem', fontSize: '1rem', borderRadius: '8px', display: 'flex', gap: '0.5rem', minWidth: '200px' }} onClick={() => navigate('/checkout')}>
